...
def dump_config(rcpath, quiet=False, verbose=False):
    ...
    CONFIG[50] = 'askpass = {} ; SUDO_ASKPASS utility for Homebrew Casks'.format(launch_askpass(quiet, verbose).ljust(49))
    CONFIG[51] = 'confirm = {} ; confirm utility for MacDaily'.format(launch_confirm(quiet, verbose).ljust(49))
